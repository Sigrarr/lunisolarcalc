 ...
 *
 * It should be 'atomic', i.e. it should {@link #calculate(Object, Map) calculate}
...
public interface Provider<SubjectT extends Enum<SubjectT>, InT> {
     ...
     * in order to perform its own {@link #calculate(Object, Map) calculation}.
     *
     * If this provider operates solely on a root input and does not require
     * values of any subjects, returns {@link EnumSet#noneOf(Class) an empty set}, not null.
     *
    ...
    /**
     * Calculates a value of the subject {@link #provides() provided} by this object.
     ...
     * {@link #requires() required} by this provider. An object retrieved from the map
     ...
     *                              {@link #requires() required} by this provider
     * @return                      value of the subject {@link #provides() provided} by this object
     */
