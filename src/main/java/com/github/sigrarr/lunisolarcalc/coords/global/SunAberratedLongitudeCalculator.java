...
public final class SunAberratedLongitudeCalculator implements Provider<GlobalCoord, TimelinePoint> {
    /**
     * Calculates {@linkplain GlobalCoord#SUN_ABERRATED_LONGITUDE the Sun's longitude with correction due to aberration}.
     * Quick.
     *
    ...
    public GlobalCoord provides() {
        return GlobalCoord.SUN_ABERRATED_LONGITUDE;
    }
