...
public class MoonCoordinateElements implements Provider<GlobalCoord, TimelinePoint>, DoubleRow {
    ...
    @Override
    public MoonCoordinateElements calculate(TimelinePoint tx, Map<GlobalCoord, Object> precalculatedValues) {
        calculate(tx);
        return this;
    }

    @Override
    public Provider<GlobalCoord, TimelinePoint> getInstanceForNewComposition() {
