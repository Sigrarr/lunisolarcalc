...
/**
 * Calculator of {@linkplain Subject#SUN_RIGHT_ASCENSION the Sun's right ascension (α)}.
...
public final class SunRightAscensionCalculator extends Transformations implements Provider<Subject, TimelinePoint> {
    ...
    /**
     * Calculates {@linkplain Subject#SUN_RIGHT_ASCENSION the Sun's right ascension (α)}: [0, 2π).
     * Quick.
     *
     ...
     * @return                      {@linkplain Subject#SUN_RIGHT_ASCENSION the Sun's right ascension (α)}, in radians: [0, 2π)
     */
