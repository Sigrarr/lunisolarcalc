...
public class SunApparentLongitudeCalculatorTest {
    ...
    public void shouldCalculateLambda() {
        ...
        assertEquals(exampleLambdaDegrees, actualLambdaDegrees, degreesPerTimeMiliseconds(4450));
        ...
        assertEquals(trueVSOP87LambdaDegrees, actualLambdaDegrees, degreesPerTimeMiliseconds(6700));
        ...
        assertEquals(89.994045, actualLambdaDegrees, degreesPerTimeMiliseconds(4450));
    }
}
