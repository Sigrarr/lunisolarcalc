...
public class HeliocentricEclipticCoordinateCalculatorTest {
    /**
    ...
    private HeliocentricEclipticCoordinateCalculator earthLongitudeCalculator = new HeliocentricEclipticCoordinateCalculator(new PeriodicTermsForEarthLongitude());
