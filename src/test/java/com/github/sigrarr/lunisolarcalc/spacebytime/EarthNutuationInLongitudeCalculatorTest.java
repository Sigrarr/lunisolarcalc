...
public class EarthNutuationInLongitudeCalculatorTest {
    ...
    public void shouldCalculateDeltaPsi() {
        ...
        assertEquals(-3.788, Calcs.toArcseconds(Math.toDegrees(actualDeltaPsi)), TROPICAL_YEAR.arcsecondsPerTimeMiliseconds(40));
        ...
        assertEquals(15.908, Calcs.toArcseconds(Math.toDegrees(actualDeltaPsi)), TROPICAL_YEAR.arcsecondsPerTimeMiliseconds(230));

        // Meeus 1998, Example 27.b, pp. 180-181
        cT = Timeline.julianDayToCenturialT(2437837.38589);
        actualDeltaPsi = calculator.calculateNutuation(cT, new EarthNutuationElements(cT));
        assertEquals(-12.965, Calcs.toArcseconds(Math.toDegrees(actualDeltaPsi)), TROPICAL_YEAR.arcsecondsPerTimeMiliseconds(230));

        // Meeus 1998, Example 47.a, pp. 342-343
        cT = -0.077221081451;
        actualDeltaPsi = calculator.calculateNutuation(cT, new EarthNutuationElements(cT));
        assertEquals(16.595, Calcs.toArcseconds(Math.toDegrees(actualDeltaPsi)), TROPICAL_YEAR.arcsecondsPerTimeMiliseconds(115));
    }
}
